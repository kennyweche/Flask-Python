...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI='mysql://admin:portmore254@localhost/dreamteam_test'
        )
        return app
    ...
    def setUp(self):
        ...
        admin = Employee(username="admin", password="portmore254", is_admin=True)

        # create test non-admin user
        employee = Employee(username="test_user", password="portmore254")
